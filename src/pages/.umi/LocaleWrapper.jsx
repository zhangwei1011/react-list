...
const localeInfo = {
  'en-US': {
    messages: require('/Applications/XAMPP/xamppfiles/htdocs/react_projects/ant-design-pro/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('/Applications/XAMPP/xamppfiles/htdocs/react_projects/ant-design-pro/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('/Applications/XAMPP/xamppfiles/htdocs/react_projects/ant-design-pro/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('/Applications/XAMPP/xamppfiles/htdocs/react_projects/ant-design-pro/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
